...
from Reading_Thread import NonBlockingStreamReader as NBSR
import tkMessageBox
from Check_Input import check 

# makes an executable of the fortran code
p = subprocess.Popen(' gfortran ./Scripts/Fortran/magboltz-11.3.f',shell=True,stdin=subprocess.PIPE,stdout=subprocess.PIPE)
